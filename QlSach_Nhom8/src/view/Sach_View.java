...
public class Sach_View extends javax.swing.JFrame {
    ...
    public void showForm() {
        ...
        txtMa.setText(tblSach.getValueAt(index, 0).toString());
        txtTenSach.setText(tblSach.getValueAt(index, 1).toString());
        txtTacGia.setText(tblSach.getValueAt(index, 2).toString());
        cbLoai.setSelectedItem(tblSach.getValueAt(index, 3).toString());
        txtSoLuong.setText(tblSach.getValueAt(index, 4).toString());
        txtNam.setText(tblSach.getValueAt(index, 5).toString());
        txtGia.setText(tblSach.getValueAt(index, 6).toString());
    }
    ...
    private void initComponents() {
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Statistics.png"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        DoanhThu_Admin dtv = new DoanhThu_Admin();
        dtv.setVisible(true);
        this.dispose();
